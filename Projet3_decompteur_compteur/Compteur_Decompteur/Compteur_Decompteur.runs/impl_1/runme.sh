...
HD_PWD='C:/Users/anass/VHDL/Projet1/Compteur_Decompteur/Compteur_Decompteur.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log compteur_leds.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source compteur_leds.tcl -notrace
