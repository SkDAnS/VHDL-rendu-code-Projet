...
HD_PWD='C:/Users/anass/VHDL/Projet1/Compteur_Decompteur/Compteur_Decompteur.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log compteur_leds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source compteur_leds.tcl
