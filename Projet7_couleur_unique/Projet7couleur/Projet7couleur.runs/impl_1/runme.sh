...
HD_PWD='C:/Users/anass/VHDL/Projet1/Projet7couleur/Projet7couleur.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_image_afficheur.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_image_afficheur.tcl -notrace
