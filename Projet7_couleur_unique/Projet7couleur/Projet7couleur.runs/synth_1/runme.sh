...
HD_PWD='C:/Users/anass/VHDL/Projet1/Projet7couleur/Projet7couleur.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_image_afficheur.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_image_afficheur.tcl
