...
HD_PWD='C:/Users/anass/VHDL/Projet1/affichage_quatre_chiffre_different/affichage_quatre_chiffre_different.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log afficheur_4digits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source afficheur_4digits.tcl -notrace
