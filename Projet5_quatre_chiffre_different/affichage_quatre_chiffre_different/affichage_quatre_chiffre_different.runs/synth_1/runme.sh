...
HD_PWD='C:/Users/anass/VHDL/Projet1/affichage_quatre_chiffre_different/affichage_quatre_chiffre_different.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log afficheur_4digits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source afficheur_4digits.tcl
