...
HD_PWD='C:/Users/anass/VHDL/Projet1/projet8_drapeau/projet8_drapeau/projet8_drapeau.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_drapeau.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_drapeau.tcl -notrace
